...
CREATE OR REPLACE TARGET bulk_L_6_LOAD_target_SS USING Global.DatabaseWriter(
  ...
  Tables:'__SOURCE_DB__.dbo.SaleStatus,__TARGET_DB__.business.sale_status columnmap(
		id=SaleStatus_id,
		guid=GUID);
...
CREATE OR REPLACE TARGET bulk_L_6_LOAD_sale_status_de USING Global.DatabaseWriter(
  ...
  PreserveSourceTransactionBoundary: '__PRSV_SRC_TRANS_BND__', 
  adapterName: 'DatabaseWriter', 
  Tables:'__SOURCE_DB__.dbo.SaleStatus, __TARGET_DB__.core.translation columnmap(
		guid=GUID,
...
CREATE OR REPLACE TARGET bulk_L_6_LOAD_year_modifier_de USING Global.DatabaseWriter(
  ...
  PreserveSourceTransactionBoundary: '__PRSV_SRC_TRANS_BND__', 
  adapterName: 'DatabaseWriter', 
  Tables:' __SOURCE_DB__.dbo.Year_Modifier, __TARGET_DB__.core.translation columnmap(
		guid=NameGUID, 
		text=DisplayName_de, 
		language=\'DE\')'
)
...
CREATE OR REPLACE TARGET bulk_L_6_LOAD_price_phrase_de USING Global.DatabaseWriter(
  ...
  PreserveSourceTransactionBoundary: '__PRSV_SRC_TRANS_BND__', 
  adapterName: 'DatabaseWriter', 
  Tables:' __SOURCE_DB__.dbo.PricePhrase, __TARGET_DB__.core.translation columnmap(
		guid=PricePhraseGUID, 
...
CREATE OR REPLACE TARGET bulk_L_6_LOAD_price_status_de USING Global.DatabaseWriter(
  ...
  PreserveSourceTransactionBoundary: '__PRSV_SRC_TRANS_BND__', 
  adapterName: 'DatabaseWriter', 
  Tables:'__SOURCE_DB__.dbo.PriceStatus, __TARGET_DB__.core.translation columnmap(
		guid=PriceStatusGUID, 
